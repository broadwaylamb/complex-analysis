...
\begin{center}
	\begin{tikzpicture}[scale=4]
	    ...
	    \draw ($(0, 0) + (2, 0)$) -- ++(120:0.6) node(line12)[right]{$\frac{2\pi}{n}$};
...
\begin{example}
	...
	\begin{tikzpicture}[scale=3,]
	    ...
	    \path[fill=black,opacity=0.2] (-0.8, 0.3) -- (0.8, 0.3) -- (0.8, 0) -- (-0.8, 0) -- cycle;
	    ...
	    \path[fill=black,opacity=0.2] ($(-0.8, 0.6) + (2, 0)$) -- ($(0.8, 0.6) + (2, 0)$) --
